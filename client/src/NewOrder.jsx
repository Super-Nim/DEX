...
// in Typescript this would be an imported interface
const TYPE = {
    LIMIT: 'LIMIT',
    MARKET: 'MARKET'
};
        ...
        <div id="orders" className="card">
            ...
            <form onSubmit={(e) => onSubmit(e)}>
                <div className="form-group row">
                    <label htmlFor="typer" className="col-sm-4 col-form-label">Type</label>
                ...
                <div className="form-group row">
                    <label htmlFor="order-amount" className="col-sm-4 col-form-label">Amount</label>
                    <div className="col-sm-8">
                        <input 
                            type="text"
                ...
                {order.type === TYPE.MARKET ? null :
                    <div className="form-group row">
                        <label htmlFor="order-amount" className="col-sm-4 col-form-label">Price</label>
                        <div className="col-sm-8">
                            <input
                                type="text"
                                className="form-control"
